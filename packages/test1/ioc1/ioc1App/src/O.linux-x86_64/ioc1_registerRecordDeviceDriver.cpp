...
/* Generated from ../O.Common/ioc1.dbd */
...
int ioc1_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/hinkokocevar/ng3e/packages/test1";
...
/* ioc1_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"ioc1_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    ioc1_registerRecordDeviceDriver(*iocshPpdbbase);
}
